...
public class Util
{
            ...
            ShellPrompt prompt)
   {
      if (rhLogin == null)
      {
         ...
         if (rhLogin == null)
         {
            ...
            rhLogin = prompt.prompt("Enter your Red Hat Login", _default);
   ...
   public static IApplication createApplication(IOpenShiftConnection openshift, ICartridge cartridge, IUser user,
            String name, ShellPrintWriter out) throws OpenShiftException
   {
