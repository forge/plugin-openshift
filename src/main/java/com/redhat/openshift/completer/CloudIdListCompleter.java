 ...
 *  
 */
public class CloudIdListCompleter extends SimpleTokenCompleter {
	@Inject
	...
	public Iterable<?> getCompletionTokens() {
		...
		for (CloudAccount a : base.getCachedCloudList()) {
			clouds.add(a.getName());
			clouds.add(Long.toString(a.getId()));
		}
		return clouds;
	}
}
